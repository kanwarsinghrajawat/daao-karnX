...
const ProjectCarousel = ({ projects }: ProjectCarouselProps) => {
  ...
  const spotlight = {
    ...
    avatar:
      spotlightProject.projectBasicInfo.logo ||
      spotlightProject.projectBasicInfo.imageDesktop,
    badge: "Featured",
    ...
    fdvChangePct:
      spotlightProject.projectBasicInfo.marketData?.fundingProgress || 85,
    category: spotlightProject.projectBasicInfo.category,
    transactions:
      spotlightProject.projectBasicInfo.marketData?.holdersCount || 1000,
    interactedWith: spotlightProject.projectBasicInfo.team
      .slice(0, 2)
