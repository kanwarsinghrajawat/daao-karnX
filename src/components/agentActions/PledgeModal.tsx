  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        <Text
          type="p"
          className="text-2xl text-left text-text-primary font-bold"
        >
          Pledge
        </Text>
      </div>

      <div className="border border-divider p-6 bg-[#171717]">
        <div className="text-center mb-6">
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <Text
              type="p"
              className="text-text-secondary text-sm font-normal leading-relaxed"
            >
