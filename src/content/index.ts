...
export const howToParticipateSteps = [
  { title: 'Connect: Connect Wallet', description: 'Connect your wallet and make sure you are on the Haven1 network.' },
  { title: 'Pledge: Fund the Agent', description: 'Select the amount of the asset you want to fund the Agent with.' },
  {
    title: 'Share: Spread the Word',
    description: 'Agents must meet the minimum funding thresholds to initiate. Share to your network to get it funded.',
  },
  {
    title: 'Redeem: Collect your Funds',
    description: 'At the end of the agents lifespan, you can redeem the Agent token for your initial deposit asset.',
  },
];
